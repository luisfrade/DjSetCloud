    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-900 border-t border-white/10">
      ...
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-4">
        ...
        <div className="relative">
          ...
          {showVolume && (
            <div
              className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 bg-gray-800 border border-white/10 rounded-xl px-3 py-3 flex items-center gap-3 shadow-xl"
